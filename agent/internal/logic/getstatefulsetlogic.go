...
func (l *GetStatefulsetLogic) GetStatefulset(in *agent.GetWorkloadRequest) (*agent.Response, error) {
	res, err := l.K8sService.GetStatefulset(in.Namespace, in.WorkloadName)
	if err != nil {
