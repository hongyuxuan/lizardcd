...
var listCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err := common.LizardServer.Get(fmt.Sprintf("/lizardcd/cluster/%s/namespace/%s/deployments", cluster, namespace)).SetResult(&res).Do(context.Background()).Err; err != nil {
