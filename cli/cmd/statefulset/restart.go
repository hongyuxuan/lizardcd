...
var restartCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err := common.LizardServer.Patch(fmt.Sprintf("/lizardcd/cluster/%s/namespace/%s/statefulsets/%s/rollout", cluster, namespace, name)).Do(context.Background()).Err; err != nil {
