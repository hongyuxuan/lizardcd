...
import (
	...
	git "github.com/hongyuxuan/lizardcd/server/internal/handler/git"
	...
	tekton "github.com/hongyuxuan/lizardcd/server/internal/handler/tekton"
		...
		[]rest.Route{
			{
				Method:  http.MethodGet,
				Path:    "/config",
				Handler: lizardcd.ConfigHandler(serverCtx),
			},
			{
				Method:  http.MethodGet,
				Path:    "/oauth2",
				Handler: lizardcd.Oauth2Handler(serverCtx),
			},
		},
		rest.WithPrefix("/lizardcd/server"),
	)
	...
	server.AddRoutes(
		[]rest.Route{
			...
			},
			{
				Method:  http.MethodGet,
				Path:    "/callback/:name",
				Handler: auth.CallbackHandler(serverCtx),
			},
		},
		rest.WithPrefix("/lizardcd/auth"),
	)
	...
	server.AddRoutes(
		rest.WithMiddlewares(
			...
			[]rest.Route{
				...
				{
					Method:  http.MethodGet,
					Path:    "/cluster/:cluster/namespace/:namespace/gateways",
					Handler: istio.ListGatewayHandler(serverCtx),
				},
				{
					Method:  http.MethodGet,
	...
	server.AddRoutes(
		rest.WithMiddlewares(
			...
			[]rest.Route{
				...
				{
					Method:  http.MethodGet,
					Path:    "/cluster/:cluster/namespace/:namespace/pods/:pod_name/logs",
					Handler: kubernetes.PodLogsHandler(serverCtx),
				},
				{
					Method:  http.MethodGet,
				...
				},
				{
					...
					Handler: kubernetes.SethpaHandler(serverCtx),
				},
				{
					Method:  http.MethodGet,
					Path:    "/cluster/:cluster/namespace/:namespace/deployments/:workload_name/hpa",
		...
		rest.WithMiddlewares(
			...
			[]rest.Route{
				...
				},
				{
					Method:  http.MethodPost,
					Path:    "/execute/:id",
					Handler: task.ExecuteTaskHandler(serverCtx),
				},
				{
					Method:  http.MethodGet,
					Path:    "/stats",
					Handler: task.TaskstatsHandler(serverCtx),
				},
				{
					Method:  http.MethodGet,
					Path:    "/history_by_application",
					Handler: task.ApphistoryHandler(serverCtx),
				},
			}...,
		),
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
	...
	server.AddRoutes(
		rest.WithMiddlewares(
			...
			[]rest.Route{
				{
					Method:  http.MethodGet,
					Path:    "/cluster/:cluster/namespace/:namespace/endpoint",
					Handler: tekton.GetTektonEndpointHandler(serverCtx),
				},
				{
					Method:  http.MethodGet,
					Path:    "/cluster/:cluster/namespace/:namespace/:resource_type",
					Handler: tekton.ListTektonResourceHandler(serverCtx),
				},
				{
					Method:  http.MethodGet,
					Path:    "/cluster/:cluster/namespace/:namespace/:resource_type/:resource_name",
				...
				},
				{
					Method:  http.MethodDelete,
					Path:    "/cluster/:cluster/namespace/:namespace/:resource_type/:resource_name",
					Handler: tekton.DeleteTektonHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/cluster/:cluster/namespace/:namespace/apply",
					Handler: tekton.ApplyTektonHandler(serverCtx),
				},
			}...,
		),
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
			...
			[]rest.Route{
				{
					Method:  http.MethodGet,
					Path:    "/sync/status",
					Handler: git.SyncstatusHandler(serverCtx),
				},
				{
					Method:  http.MethodGet,
					Path:    "/cron",
					Handler: git.CronHandler(serverCtx),
				},
				{
					Method:  http.MethodDelete,
					Path:    "/cron",
					Handler: git.DeletecronHandler(serverCtx),
				},
			}...,
		),
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
		rest.WithPrefix("/lizardcd/git"),
	)
}
