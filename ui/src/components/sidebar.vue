<template>
  <el-scrollbar>
    ...
    <el-menu
        ...
        <el-menu-item index="/template"><font-awesome-icon icon="ghost" />应用模板</el-menu-item>
        <el-sub-menu index="2">
          <template #title>
            <font-awesome-icon icon="layer-group" />
            <span>工作负载</span>
          </template>
          <el-menu-item index="/workload/deployment">部署</el-menu-item>
          <el-menu-item index="/workload/statefulset">有状态副本集</el-menu-item>
        </el-sub-menu>
    </el-menu>
  </el-scrollbar>
</template>
