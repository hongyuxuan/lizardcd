...
<el-card>
  ...
  <el-table :data="list" class="line-height40" style="width:100%;" :show-header="false">
...
/* methods */
const getList = async () => {
  let response = await axios.get(`/consul/services`)
  for(let x of response) {
    let serviceIds = await axios.get(`/consul/services/${x.service_name}`)
