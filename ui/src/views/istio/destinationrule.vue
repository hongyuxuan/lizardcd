...
<div class="box box-item">
  <div class="box-body" style="padding-top:20px;padding-bottom:0">
    <el-alert type="warning" show-icon style="margin-bottom:15px">
      <template #title>
        关于 DestinationRule 配置参考：<el-link href="https://istio.io/latest/zh/docs/reference/config/networking/destination-rule/" underline="never" type="primary" target="_blank">Destination Rule</el-link>
      </template>
    </el-alert>
    <el-row>
      <el-col :span="12">
