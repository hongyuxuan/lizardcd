...
<div class="box box-item">
  <div class="box-body" style="padding-top:20px;padding-bottom:0">
    <el-alert type="warning" show-icon style="margin-bottom:15px">
      <template #title>
        关于 VirtualService 配置参考：<el-link href="https://istio.io/latest/zh/docs/reference/config/networking/virtual-service/" :underline="false" type="primary" target="_blank">Virtual Service</el-link>
      </template>
    </el-alert>
    <el-row>
      <el-col :span="12">
    ...
    <el-table 
      ...
      <el-table-column label="" width="45">
        <font-awesome-icon icon="shuffle" style="font-size:22px;vertical-align:middle;" />
      </el-table-column>
      ...
      <el-table-column label="网关" min-width="250">
        <template #default="scope">
          {{ scope.row.spec.gateways }}
        </template>
      </el-table-column>
      <el-table-column label="主机" min-width="250">
        <template #default="scope">
          {{ scope.row.spec.hosts }}
        </template>
      </el-table-column>
