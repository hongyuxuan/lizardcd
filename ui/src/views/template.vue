...
<el-breadcrumb :separator-icon="ArrowRight">
  ...
  <el-breadcrumb-item>应用模板</el-breadcrumb-item>
</el-breadcrumb>
<el-card>
  <template #header>
    <div class="card-header">
      <span class="card-header-text">应用模板</span>
      <span class="pull-right pointer" @click="getList(current)"><el-icon><Refresh /></el-icon></span>
    </div>
  </template>
  <el-row>
    <el-alert title="关于应用模板用法参考Go-template：https://pkg.go.dev/text/template" type="warning" style="margin-bottom:15px" />
    <el-col :span="12">
      <el-button-group>
